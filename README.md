...
- [ ] *Видение продукта*
- [ ] *Ценности* продуктовой разработки
### Культура и процесс
- [ ] *Производственная культура* и осознание личной и командной культур
...
- [ ] Ключевые метрики продуктового бизнеса
...
```
Мы поможем двигать продукт вперёд по бизнес-метрикам к успеху за счёт быстрых эффективных проверок новых гипотез и анализа текущего использования. 
Мы обеспечим качество продукта в условиях непрерывного потока изменений за счёт осмысленного применения современных инженерных практик. 
Наше преимущество - быстрая реакция на любые изменения, это удаётся нам за счёт сознательного развития высокоадаптивной внутренней культуры. 
```
...
- [ ] Подход к rework. Измерение внешнего и внутреннего качества через метрику rework
- [ ] Подход к структуре команд: feature teams vs matrix. Свойства feature team
...
- [ ] Подход к экспертизе: фокусировка или кросс-функциональность. Практика Star Map.
### Декларируем наши команды на соответствие критериям
- [ ] Star Map
- [ ] Манифест команды + trade-offs
...
- [ ] PBI DoD как артефакт внутренней модели качества
...
- [ ] Выбор родуктовой гипотезы для реализации в рабочей системе
- [ ] PO сформирует итоговые vision и epics
#### Ретро
...
- [ ] Как задавать NFRs: свойства историй и антипаттерны: системные/инфраструктурные stories
- [ ] Почему важно декомпозировать истории? Как обеспечить "тонкую нарезку" инкрементов?
