...
![](https://github.com/eugene-krivosheyev/agile-practices-for-developers/blob/master/vision.png?raw=true)
...
- [ ] Измерение внешнего и внутреннего качества через метрику rework
...
### Заключение
- Инертность системы для продктового бизнеса
